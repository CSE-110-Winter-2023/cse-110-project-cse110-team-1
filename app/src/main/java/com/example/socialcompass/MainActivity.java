...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        String label_0 = preferences.getString("label_0","default");
        String longitude_0 = preferences.getString("longitude_0","default");
        String latitude_0 = preferences.getString("latitude_0","default");
        ...
        String label_1 = preferences.getString("label_1","default");
        String longitude_1 = preferences.getString("longitude_1","default");
        String latitude_1 = preferences.getString("latitude_1","default");
        String label_2 = preferences.getString("label_2","default");
        String longitude_2 = preferences.getString("longitude_2","default");
        String latitude_2 = preferences.getString("latitude_2","default");

        if (!label_1.equals("default")) {
    ...
    public void onSubmitButtonClick(View view) {
        ...
        if (Utilities.isValidAll(labelStr_0,longitudeStr_0,latitudeStr_0)) {
            ...
            Utilities.showAlert(this,"Input 1 is not Valid, Please check");
        }

        View groupView_1 = findViewById(R.id.input_group_1);
        View groupView_2 = findViewById(R.id.input_group_2);

        if (groupView_1.getVisibility() == View.VISIBLE) {
            TextView labelView_1 = findViewById(R.id.label_1);
            ...
            if (Utilities.isValidAll(labelStr_1,longitudeStr_1,latitudeStr_1)) {
                SharedPreferences preferences = getPreferences(MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                ...
                Utilities.showAlert(this,"Input 2 is not Valid, Please check");
            }
        }


        if (groupView_2.getVisibility() == View.VISIBLE) {
            TextView labelView_2 = findViewById(R.id.label_2);
            String labelStr_2 = labelView_0.getText().toString().trim();
            TextView longitudeView_2 = findViewById(R.id.longitude_2);
            String longitudeStr_2 = longitudeView_0.getText().toString().trim();
            TextView latitudeView_2 = findViewById(R.id.latitude_2);
            String latitudeStr_2 = latitudeView_2.getText().toString().trim();
            if (Utilities.isValidAll(labelStr_2,longitudeStr_2,latitudeStr_2)) {
                SharedPreferences preferences = getPreferences(MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                ...
                Utilities.showAlert(this,"Input 3 is not Valid, Please check");
            }
        }
        SharedPreferences preferences = getPreferences(MODE_PRIVATE);
        String label_0 = preferences.getString("label_0","default");
        ...
        String longitude_2 = preferences.getString("longitude_2","default");
        String latitude_2 = preferences.getString("latitude_2","default");
        Utilities.showAlert(this,label_0+" "+longitude_0+" "+latitude_0+ "\n"
            +label_1+" "+longitude_1+" "+latitude_1+ "\n"
                +label_2+" "+longitude_2+" "+latitude_2);
